                ...
                <div className="aboutus-background">
                    ...
                    <div className="aboutus-background-text">
                        <p className="aboutus-text">
                            Established in April 2023, the Leeds Think Tank
                            (LTT) endeavours to facilitate the engagement of
                            young individuals in ongoing policy dialogues,
                            thereby amplifying the voices of the
                            underrepresented Northern communities. Through
                            initiatives encompassing funding for informative
                            speaker engagements, publication of student-authored
                            articles in influential newspapers, and
                            collaborative delivery of skill-enhancing workshops
                            in conjunction with the university, LTT seeks to
                            empower its student members and contribute to the
                            betterment society.
                        </p>
                    </div>
                </div>
